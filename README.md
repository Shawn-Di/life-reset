...
-这是一个会主动提醒你重新审视生活方向的Skill。
-本意是为了激励我自己而写的。因为我会习惯性的拖延我生活中的任何事情。
-但如果大家也用的习惯的话那就跟好啦，我会很开心！！！
...
2/ 安装完成后他会创建一个自动化，默认是8:00-20:00，你可以自定义这个提醒的时间，也可以自定义你想要的称呼。
-但是请允许这个自动化执行，否则他将不会生效。
